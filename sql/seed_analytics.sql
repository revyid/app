-- ============================================================
-- FAKE ANALYTICS DATA
-- Generates ~200 page views spread across last 30 days
-- with realistic referrer sources
-- Run this in Supabase SQL Editor
-- ============================================================

-- Clear existing fake data (optional, uncomment if needed)
-- DELETE FROM analytics_events WHERE event_type = 'page_view';

-- Insert ~200 page views spread across last 30 days
...
CROSS JOIN
  -- Referrers (realistic traffic sources)
  (VALUES
    (NULL),
    (NULL),
    (NULL),
    ...
    ('https://dev.to/revyid'),
    ('https://stackoverflow.com/users/revyid'),
    ('https://www.reddit.com/r/webdev'),
    ('https://producthunt.com'),
    ('https://hackernews.com'),
    ('https://www.youtube.com/watch?v=revyid')
