...
export const profileData = {
  ...
  pronouns: 'he/him',
  verified: true,
  image: 'https://ui-avatars.com/api/?name=Revy&background=0D8ABC&color=fff&size=200',
  about: 'I am a full-stack software engineer with 2+ years of experience in building web and mobile apps.',
  easter_egg: {
    name: 'Nawa',
    image: 'https://ui-avatars.com/api/?name=Nawa&background=E8A0BF&color=fff&size=200',
    shortcut: 'Ctrl+Alt+L',
  },
};
